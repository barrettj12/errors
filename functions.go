...
// was called from and returns wrapped error with the location information set.
// The returned error implements the Locationer interface. If err is nil then a
